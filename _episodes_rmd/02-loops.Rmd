...
> ## Challenge 1
>
> Write a script that loops through the `mtcars` data by continent and prints out
> whether the mean mpg is lower or higher than 20 miles per gallon for each category of cyl (cylinders) in vehicles.
>
