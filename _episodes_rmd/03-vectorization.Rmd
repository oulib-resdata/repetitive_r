...
- "To use lapply() (and learn about related functions) to apply to multiple elements at once"
keypoints:
...
the lapply function
Use the figure from here: https://adv-r.hadley.nz/functionals.html#map

> ## Tip: map() in 'purrr' package.
>
> "The base equivalent to map() is lapply(). The only difference is that 
